...
<nav id="webcomic-display-nav-up" class="webcomic-nav-wrapper" >
	<ul id="webcomic-nav-up" class="webcomic-nav">
		...
		<?php if (get_post_type() == "webcomic1"):?>
			<li id= "webcomic-nav-middle-btn" class="webcomic-nav-button" ><?php  webcomic_dropdown_storylines( array( "id"=>"webcomic-dropdown", "class"=> "webcomic-dropdown-menu", "collection"=>get_post_type(), "show_option_all"=>"Escolha uma História","webcomics"=>true, "selected" => $id ? $id : $post->ID) ); ?></li>
		<?php else : ?>
